...
echo "Starting Modbus server $SCRIPT_DIR/modbus_server3."
$TEST_DIR/modbus_server3 --listen=127.0.0.1:1502 --listen=127.0.0.1:2502 --debug=DETAIL > "$LOG_DIR/modbus_server3.log" 2>&1 &
MODBUS_PID=$!
