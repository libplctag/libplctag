...
echo "Starting Modbus server $SCRIPT_DIR/modbus_server2."
$TEST_DIR/modbus_server2 --listen=127.0.0.1:1502 --listen=127.0.0.1:2502 --debug=DETAIL > "$LOG_DIR/modbus_server2.log" 2>&1 &
MODBUS_PID=$!
