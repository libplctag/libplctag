...
cmd /c ""%TEST_DIR%\ab_server.exe" --debug --plc=ControlLogix --path=1,0 --tag=TestBigArray:DINT[2000] --tag=Test_Array_1:DINT[1000] --tag=Test_Array_2x3:DINT[2,3] --tag=Test_Array_2x3x4:DINT[2,3,4] ^> logix_fast_emulator.log 2^>^&1" ^>nul 2^>^&1
...
cmd /c ""%TEST_DIR%\ab_server.exe" --plc=ControlLogix --path=1,0 --tag=TestBigArray:DINT[2000] --tag=Test_Array_1:DINT[1000] --tag=Test_Array_2x3:DINT[2,3] --tag=Test_Array_2x3x4:DINT[2,3,4] --delay=50 ^> logix_slow_emulator.log 2^>^&1" ^>nul 2^>^&1
...
cmd /c ""%TEST_DIR%\ab_server.exe" --debug --plc=Micro800 --tag=TestDINTArray:DINT[10] ^> micro800_emulator.log 2^>^&1" ^>nul 2^>^&1
...
cmd /c ""%TEST_DIR%\ab_server.exe" --debug --plc=Omron --tag=TestDINTArray:DINT[10] ^> omron_emulator.log 2^>^&1" ^>nul 2^>^&1
...
cmd /c ""%TEST_DIR%\ab_server.exe" --debug --plc=Micrologix --tag=B3[10] --tag=N7[10] --tag=L19[10] ^> micrologix_emulator.log 2^>^&1" ^>nul 2^>^&1
...
cmd /c ""%TEST_DIR%\ab_server.exe" --debug --plc=PLC/5 --tag=B3[10] --tag=N7[10] ^> plc5_emulator.log 2^>^&1" ^>nul 2^>^&1
...
cmd /c ""%TEST_DIR%\modbus_server.exe" --listen=127.0.0.1:1502 --listen=127.0.0.1:2502 --debug=DETAIL ^> modbus_server.log 2^>^&1" ^>nul 2^>^&1
