...
const (
	...
	DEBUG_NONE   = C.PLCTAG_DEBUG_NONE
	DEBUG_ERROR  = C.PLCTAG_DEBUG_ERROR
	DEBUG_WARN   = C.PLCTAG_DEBUG_WARN
	DEBUG_INFO   = C.PLCTAG_DEBUG_INFO
	DEBUG_DETAIL = C.PLCTAG_DEBUG_DETAIL
	DEBUG_SPEW   = C.PLCTAG_DEBUG_SPEW
)
